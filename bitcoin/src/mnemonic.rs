...
mod tests {
    ...
    fn test_from_entropy<N: BitcoinNetwork, W: BitcoinWordlist>(entropy: &Vec<u8>, expected_phrase: &str) {
    ...
    fn test_to_entropy<N: BitcoinNetwork, W: BitcoinWordlist>(expected_entropy: &Vec<u8>, phrase: &str) {
