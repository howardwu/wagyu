...
fn main() {
    ...
    let arg_bech32 = Arg::from_usage("[bech32] -b --bech32 'Generate a wallet with a Bech32 (SegWit enabled) address'")
        .conflicts_with("segwit");
    let arg_segwit = Arg::from_usage("[segwit] -s --segwit 'Generate a wallet with a Segwit address'")
