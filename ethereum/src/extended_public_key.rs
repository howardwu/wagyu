...
mod tests {
    ...
    fn test_from_extended_private_key(
        ...
        assert_eq!(expected_public_key, extended_public_key.public_key.0.to_string());
    ...
    fn test_derive(
        ...
        let expected_extended_public_key2 = EthereumExtendedPublicKey::from_str(&expected_extended_public_key2).unwrap();
